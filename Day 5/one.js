...
a region the given seat is in. Start with the whole list of rows; the first letter 
...
const getMaxSeatIdFromTickets = tickets => Math.max(...getIdsFromTickets(tickets));

console.log(getMaxSeatIdFromTickets(tickets));
